...
## For final project
final_project = True # True or False
...
##Limit range of y for final project
configs_det.lim_y = [-25, 25] #y-range in the final project
...
while True:
    try:
        ...
        if 'bev_from_pcl' in exec_list:
            ...
            lidar_bev = pcl.bev_from_pcl(lidar_pcl, configs_det, True)
        else:
