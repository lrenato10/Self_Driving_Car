...
#values from mid-term project in fpn_resnet
sigma_lidar_x = 0.1521
sigma_lidar_y = 0.0520
sigma_lidar_z = 0.1649
#sigma_lidar_x = 0.0705
#sigma_lidar_y = 0.0518
#sigma_lidar_z = 0.0748
