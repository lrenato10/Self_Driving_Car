...
class Association:
    ...
    def associate(self, track_list, meas_list, KF):
        ...
        for i in range(N): 
            ...
            for j in range(M):
                ...
                if self.gating(dist, meas.sensor): # put in the association matrix only if MHD is in the gating range
    ...
    def get_closest_track_and_meas(self):
        ...
        A = np.delete(A, ind_track, 0) # delete row of tracks
        A = np.delete(A, ind_meas, 1) # delete column of measurements
    ...
    def MHD(self, track, meas, KF):
        ...
        H = meas.sensor.get_H(track.x) # H(x)=Hx
