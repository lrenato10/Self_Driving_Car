...
double close_to_main_goal_cost_spiral(const std::vector<PathPoint>& spiral,
  ...
  auto delta_x = spiral[n - 1].x - main_goal.location.x;  // <- Update
  auto delta_y = spiral[n - 1].y - main_goal.location.y;  // <- Update
  auto delta_z = spiral[n - 1].z - main_goal.location.z;  // <- Update
