...
// Planning Constants
#define P_NUM_PATHS 7                  // TODO - Num of paths (goals) (recommended between 5 and 7)
...
#define P_NUM_POINTS_IN_SPIRAL 25       // TODO - Num of points in the spiral (high will be slow, low will be miss detection collisions) (recommended between 20 and 25)
